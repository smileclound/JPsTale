monster = [
	...
	drops:[
		...
		[probability:3250, code:"GG101", value:[30, 60]/* Gold */],
		...
		[probability:30, code:"WH104"/* 巨灵锤 */],
		[probability:30, code:"WM104"/* 涤荡之杖 */],
		[probability:30, code:"WP105"/* 鸠牙战镰 */],
		[probability:30, code:"WS104"/* 十字弩 */],
		[probability:30, code:"WS204"/* 短剑 */],
		[probability:30, code:"WT104"/* 铁标 */],
		[probability:30, code:"DA204"/* 常青袍 */],
		[probability:30, code:"DA104"/* 铠甲 */],
		[probability:30, code:"DS104"/* 轻盾 */],
		[probability:30, code:"DB104"/* 精铜靴 */],
		[probability:30, code:"DG104"/* 银贝护手 */],
		[probability:30, code:"OM104"/* 龙骨念珠 */],
		[probability:30, code:"PM101"/* 低级恢复魔法药水 */],
		[probability:30, code:"PL101"/* 低级复生命药水 */],
		[probability:30, code:"PS101"/* 低级恢复耐力药水 */],
		[probability:30, code:"EC101"/* 回城卷 */],
		[probability:30, code:"OR105"/* 蓝宝石戒指 */],
		[probability:30, code:"OA105"/* 梦之心链 */],
