...
import net.jmecn.asset.FallItem;

public class CharMonsterInfo extends CharInfo implements
		Comparable<CharMonsterInfo> {

	public CharMonsterInfo() {
	...
	@Override
	public int compareTo(CharMonsterInfo monster) {
		if (this == monster) {
			return 0;
