...
public class SpcLoader implements AssetLoader {
    ...
    @Override
    public ArrayList<TRNAS_PLAYERINFO> load(AssetInfo assetInfo) throws IOException {
        /**
         * 分配内存
         */
        ...
        ArrayList<TRNAS_PLAYERINFO> npcs = new ArrayList<TRNAS_PLAYERINFO>();
        ...
        for (int i = 0; i < FIX_CHAR_MAX; i++) {
            TRNAS_PLAYERINFO playerinfo = new TRNAS_PLAYERINFO();
