monster = [
	...
	drops:[
		...
		[probability:4370, code:"GG101", value:[380, 500]/* Gold */],
		...
		[probability:25, code:"OA116"/* 苍穹之链 */],
		[probability:25, code:"OR117"/* 封魔之戒 */],
		[probability:25, code:"OA117"/* 天眼护符 */],
		[probability:25, code:"OR118"/* 封神之戒 */],
		[probability:25, code:"OA118"/* 圣光勋章 */],
		[probability:25, code:"OS104"/* 天仪石 */],
		[probability:25, code:"OS105"/* 冰晶石 */],
		[probability:25, code:"OS106"/* 玄风石 */],
		[probability:25, code:"OS107"/* 水晶石 */],
		[probability:25, code:"OS108"/* 虎翼石 */]
	],
	drops_more:[
	]
]
