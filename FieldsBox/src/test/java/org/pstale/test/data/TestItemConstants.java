...
public class TestItemConstants {
	...
	public static void main(String[] args) throws IOException {
		...
		for(int i=0; i<len; i++) {
			...
			String sql = String.format(dml, it.code, "", it.category, it.Class, it.width/22, it.height/22, it.folder, it.dorpItem,
					it.SetModelPosi, it.sound, it.WeaponClass);
