...
public class CharSound {
	...
	/**
	 * 音乐文件路径
	 * 第一个参数对应怪物的文件夹，比如Cyclops
	 * 第二个参数对应怪物的动作，如attack、dead、damage、netural、skill
	 * 第三个参数对应动作的编号，为数字1、2、3..
	 */
	...
	public final static CharSound CHAR_SOUND_CODE[] = {
			new CharSound("CYCLOPS", CHAR_SOUND_CYCLOPS),
			new CharSound("HOBGOBLIN", CHAR_SOUND_HOBGOBLIN),
			new CharSound("IMP", CHAR_SOUND_IMP),
			new CharSound("MINIG", CHAR_SOUND_MINIG),
			new CharSound("PLANT", CHAR_SOUND_PLANT),
			new CharSound("SKELETON", CHAR_SOUND_SKELETON),
			new CharSound("ZOMBI", CHAR_SOUND_ZOMBI),
			new CharSound("OBIT", CHAR_SOUND_OBIT),

			new CharSound("HOPT", CHAR_SOUND_HOPT),
			new CharSound("BARGON", CHAR_SOUND_BARGON),
			new CharSound("LEECH", CHAR_SOUND_LEECH),
			new CharSound("MUSHROOM", CHAR_SOUND_MUSHROOM),

			new CharSound("ARMA", CHAR_SOUND_ARMA),
			new CharSound("ARMADIL", CHAR_SOUND_ARMA),
			new CharSound("SCORPION", CHAR_SOUND_SCORPION),

			new CharSound("HEADCUTTER", CHAR_SOUND_HEADCUTTER),
			new CharSound("SANDLEM", CHAR_SOUND_SANDLEM),
			new CharSound("WEB", CHAR_SOUND_WEB),
			new CharSound("HOPYKING", CHAR_SOUND_HOPYKING),
			new CharSound("CRIP", CHAR_SOUND_CRIP),
			new CharSound("BUMA", CHAR_SOUND_BUMA),
			new CharSound("DECOY", CHAR_SOUND_DECOY),
			new CharSound("DORAL", CHAR_SOUND_DORAL),
			new CharSound("FIGON", CHAR_SOUND_FIGON),
			new CharSound("GOLEM", CHAR_SOUND_STONEGIANT),
			new CharSound("GREVEN", CHAR_SOUND_GREVEN),
			new CharSound("ILLUSIONKNIGHT", CHAR_SOUND_ILLUSIONKNIGHT),
			new CharSound("SKELETONRANGE", CHAR_SOUND_SKELETONRANGE),
			new CharSound("SKELETONMELEE", CHAR_SOUND_SKELETONMELEE),
			new CharSound("WOLVERLIN", CHAR_SOUND_WOLVERLIN),

			// 葛扼捞柯 脚痹 眠啊 阁胶磐

			new CharSound("RABIE", CHAR_SOUND_RABIE),
			new CharSound("MUDY", CHAR_SOUND_MUDY),
			new CharSound("SEN", CHAR_SOUND_SEN),
			new CharSound("EGAN", CHAR_SOUND_EGAN),
			new CharSound("BEEDOG", CHAR_SOUND_BEEDOG),
			new CharSound("MUTANTPLANT", CHAR_SOUND_MUTANTPLANT),
			new CharSound("MUTANTRABIE", CHAR_SOUND_MUTANTRABIE),
			new CharSound("MUTANTTREE", CHAR_SOUND_MUTANTTREE),
			new CharSound("AVELISK", CHAR_SOUND_AVELISK),
			new CharSound("NAZ", CHAR_SOUND_NAZ),
			new CharSound("MUMMY", CHAR_SOUND_MUMMY),
			new CharSound("HULK", CHAR_SOUND_HULK),
			new CharSound("HUNGKY", CHAR_SOUND_HUNGKY),
			new CharSound("SUCCUBUS", CHAR_SOUND_SUCCUBUS),
			new CharSound("DAWLIN", CHAR_SOUND_DAWLIN),
			new CharSound("SHADOW", CHAR_SOUND_SHADOW),
			new CharSound("BERSERKER", CHAR_SOUND_BERSERKER),
			new CharSound("IRONGUARD", CHAR_SOUND_IRONGUARD),
			new CharSound("FURY", CHAR_SOUND_FURY),
			new CharSound("SLIVER", CHAR_SOUND_SLIVER),

			new CharSound("RATOO", CHAR_SOUND_RATOO),
			new CharSound("STYGIANLORD", CHAR_SOUND_STYGIANLORD),
			new CharSound("OMICRON", CHAR_SOUND_OMICRON),
			new CharSound("D-MACHINE", CHAR_SOUND_DMACHINE),
			new CharSound("METRON", CHAR_SOUND_METRON),
			new CharSound("MRGHOST", CHAR_SOUND_MRGHOST),

			new CharSound("VAMPIRICBAT", CHAR_SOUND_VAMPIRICBAT),
			new CharSound("MIREKEEPER", CHAR_SOUND_MIREKEEPER),
			new CharSound("MUFFIN", CHAR_SOUND_MUFFIN),
			new CharSound("SOLIDSNAIL", CHAR_SOUND_SOLIDSNAIL),
			new CharSound("BEEVIL", CHAR_SOUND_BEEVIL),
			new CharSound("NIGHTMARE", CHAR_SOUND_NIGHTMARE),
			new CharSound("STONEGOLEM", CHAR_SOUND_STONEGOLEM),
			new CharSound("THORNCRAWLER", CHAR_SOUND_THORNCRAWLER),
			new CharSound("HEAVYGOBLIN", CHAR_SOUND_HEAVYGOBLIN),
			new CharSound("EVILPLANT", CHAR_SOUND_EVILPLANT),
			...
			new CharSound("CHAINGOLEM", CHAR_SOUND_CHAINGOLEM),
			new CharSound("DEADZONE", CHAR_SOUND_DEADZONE),
			new CharSound("GROTESQUE", CHAR_SOUND_GROTESQUE),
			new CharSound("HYPERMACHINE", CHAR_SOUND_HYPERMACHINE),
			new CharSound("IRONFIST", CHAR_SOUND_IRONFIST),
			new CharSound("MORGON", CHAR_SOUND_MORGON),
			new CharSound("MOUNTAIN", CHAR_SOUND_MOUNTAIN),
			new CharSound("RAMPAGE", CHAR_SOUND_RAMPAGE),
			new CharSound("RUNICGUARDIAN", CHAR_SOUND_RUNICGUARDIAN),
			new CharSound("SADNESS", CHAR_SOUND_SADNESS),
			new CharSound("TOWERGOLEM", CHAR_SOUND_TOWERGOLEM),
			new CharSound("VAMPIRICBEE", CHAR_SOUND_VAMPRICBEE),
			new CharSound("VAMPIRICMACHINE", CHAR_SOUND_VAMPRICMACHINE),
			new CharSound("AVELINARCHER", CHAR_SOUND_AVELIN_ARCHER),
			new CharSound("AVELINQUEEN", CHAR_SOUND_AVELIN_QUEEN),
			new CharSound("BABEL", CHAR_SOUND_BABEL),

			// ; ///////////// 酒捞胶 阁胶磐 眠啊; //////////////////
			new CharSound("MYSTIC", CHAR_SOUND_MYSTIC),
			new CharSound("ICEGOBLIN", CHAR_SOUND_ICEGOBLIN),
			new CharSound("COLDEYE", CHAR_SOUND_COLDEYE),
			new CharSound("FROZEN", CHAR_SOUND_FROZEN),
			new CharSound("ICEGOLEM", CHAR_SOUND_ICEGOLEM),
			new CharSound("FROST", CHAR_SOUND_FROST),
			new CharSound("CHAOSCARA", CHAR_SOUND_CHAOSCARA),
			new CharSound("DEATHKNIGHT", CHAR_SOUND_DEATHKNIGHT),

			// ; /////////// 弊府叼龋荐 阁胶磐 眠啊; ////////////////
			new CharSound("GREATE_GREVEN", CHAR_SOUND_GREATE_GREVEN),
			new CharSound("LIZARDFOLK", CHAR_SOUND_LIZARDFOLK),
			new CharSound("M_LORD", CHAR_SOUND_M_LORD),
			new CharSound("SPIDER", CHAR_SOUND_SPIDER),
			new CharSound("STINGRAY", CHAR_SOUND_STINGRAY),
			new CharSound("STRIDER", CHAR_SOUND_STRIDER),
			new CharSound("OMU", CHAR_SOUND_OMU),

			// ; /////////// 酒捞胶2 阁胶磐 眠啊; ////////////////
			new CharSound("TURTLECANNON", CHAR_SOUND_TURTLE_CANNON),
			new CharSound("DEVILBIRD", CHAR_SOUND_DEVIL_BIRD),
			new CharSound("BLIZZARDGIANT", CHAR_SOUND_BLIZZARD_GIANT),
			new CharSound("KELVEZU", CHAR_SOUND_KELVEZU),

			// ; /////////// 脚痹鞘 阁胶磐 眠啊; ////////////////
			new CharSound("DARKPHALANX", CHAR_SOUND_DARKPHALANX),
			new CharSound("BLOODYKNIGHT", CHAR_SOUND_BLOODYKNIGHT),
			new CharSound("CHIMERA", CHAR_SOUND_CHIMERA),
			new CharSound("FIREWORM", CHAR_SOUND_FIREWORM),
			new CharSound("HELLHOUND", CHAR_SOUND_HELLHOUND),
			new CharSound("DARKGUARD", CHAR_SOUND_DARKGUARD),
			new CharSound("DARKMAGE", CHAR_SOUND_DARKMAGE),

			new CharSound("MONMOKOVA", CHAR_SOUND_MOKOVA),
			new CharSound("MONTEMPLEGUARD", CHAR_SOUND_TEMPLEGUARD),
			new CharSound("MONSETO", CHAR_SOUND_SETO),
			new CharSound("MONKINGSPIDER", CHAR_SOUND_KINGSPIDER),
			// ; //////////// pluto 脚痹鞘靛 阁胶磐; //////////////
			new CharSound("D_KN", CHAR_SOUND_REVIVED_KNIGHT),
			new CharSound("D_MAGI", CHAR_SOUND_REVIVED_MAGICIAN),
			new CharSound("D_ATAL", CHAR_SOUND_REVIVED_ATALANTA),
			new CharSound("D_FI", CHAR_SOUND_REVIVED_FIGTHER),
			new CharSound("D_AR", CHAR_SOUND_REVIVED_ARCHER),
			new CharSound("D_MECA", CHAR_SOUND_REVIVED_MECANICIAN),
			new CharSound("D_PA", CHAR_SOUND_REVIVED_PIKEMAN),
			new CharSound("D_PR", CHAR_SOUND_REVIVED_PRIESTESS),
			new CharSound("DEADHOPT", CHAR_SOUND_DEADHOPT),
			new CharSound("DEADKINGHOPY", CHAR_SOUND_DEADKINGHOPY),
			new CharSound("GORGON", CHAR_SOUND_GORGON),
			new CharSound("HOBOGOLEM", CHAR_SOUND_HOBOGOLEM),

			// 冠犁盔 - 历林罐篮 脚傈 3摸(脚痹鞘靛 阁胶磐)
			new CharSound("NIKEN", CHAR_SOUND_NIKEN),
			new CharSound("MIMIC", CHAR_SOUND_MIMIC),
			new CharSound("KINGBAT", CHAR_SOUND_KINGBAT),
			new CharSound("GOBLINSHAMAN", CHAR_SOUND_GOBLINSHAMAN),
			new CharSound("HEST", CHAR_SOUND_HEST),

			// 冠犁盔 - 场绝绰 啪 3摸(脚痹鞘靛 阁胶磐)
			new CharSound("RUCA", CHAR_SOUND_RUCA),
			new CharSound("NAZSENIOR", CHAR_SOUND_NAZSENIOR),
			new CharSound("IGOLATION", CHAR_SOUND_IGOLATION),
			new CharSound("KAKOA", CHAR_SOUND_KAKOA),
			new CharSound("SPRIN", CHAR_SOUND_SPRIN),
			new CharSound("UNDEADMAPLE", CHAR_SOUND_UNDEADMAPLE),
			...
			// ; ///////////// 捞亥飘侩 NPC; //////////////////
			new CharSound("MORIF", CHAR_SOUND_NPC_MORIF),
			new CharSound("MOLLYWOLF", CHAR_SOUND_NPC_MOLLYWOLF),
			new CharSound("SKILLMASTER", CHAR_SOUND_NPC_SKILLMASTER),
			new CharSound("MAGE", CHAR_SOUND_NPC_MAGICMASTER),
			new CharSound("WORLDCUP", CHAR_SOUND_WORLDCUP),
			new CharSound("WATERMELON", CHAR_SOUND_WATERMELON), // 厘喊 - 荐冠阁胶磐

			// ; ///////////// 胶懦 家券侩; //////////////////

			new CharSound("WOLVERIN", CHAR_SOUND_S_WOLVERLIN),
			new CharSound("METALGOLEM", CHAR_SOUND_S_METALGOLEM),
			...
			// 厘喊 - 家匡胶沛
			new CharSound("S_AVELIN", CHAR_SOUND_S_AVELIN),
			new CharSound("S_BAGON", CHAR_SOUND_S_BAGON),
			new CharSound("S_BEEDOG", CHAR_SOUND_S_BEEDOG),
			new CharSound("S_BEEVIL", CHAR_SOUND_S_BEEVIL),
			new CharSound("S_BERSERKER", CHAR_SOUND_S_BERSERKER),
			new CharSound("S_BUMA", CHAR_SOUND_S_BUMA),
			new CharSound("S_COKRIS", CHAR_SOUND_S_COKRIS),
			new CharSound("S_COLDEYE", CHAR_SOUND_S_COLDEYE),
			new CharSound("S_CRYPT", CHAR_SOUND_S_CRYPT),
			new CharSound("S_CYCLOPS", CHAR_SOUND_S_CYCLOPS),
			new CharSound("S_DEADZONE", CHAR_SOUND_S_DEADZONE),
			new CharSound("S_DECOY", CHAR_SOUND_S_DECOY),
			new CharSound("S_D-Machine", CHAR_SOUND_S_DMACHINE),
			new CharSound("S_EVILSNAIL", CHAR_SOUND_S_EVILSNAIL),
			new CharSound("S_GREVEN", CHAR_SOUND_S_GREVEN),
			new CharSound("S_GROTESQUE", CHAR_SOUND_S_GROTESQUE),
			new CharSound("S_ICEGOBLIN", CHAR_SOUND_S_ICEGOBLIN),
			new CharSound("S_ICEGOLEM", CHAR_SOUND_S_ICEGOLEM),
			new CharSound("S_INCUBUS", CHAR_SOUND_S_INCUBUS),
			new CharSound("S_KINGHOPY", CHAR_SOUND_S_KINGHOPY),
			new CharSound("S_LEECH", CHAR_SOUND_S_LEECH),
			new CharSound("S_LIZARDFOLK", CHAR_SOUND_S_LIZARDFOLK),
			new CharSound("S_MEPHIT", CHAR_SOUND_S_MEPHIT),
			new CharSound("S_METRON", CHAR_SOUND_S_METRON),
			new CharSound("S_MUFFIN", CHAR_SOUND_S_MUFFIN),
			new CharSound("S_MUMMY", CHAR_SOUND_S_MUMMY),
			new CharSound("S_NAZ", CHAR_SOUND_S_NAZ),
			new CharSound("S_OMEGA", CHAR_SOUND_S_OMEGA),
			new CharSound("S_RAMPAGE", CHAR_SOUND_S_RAMPAGE),
			new CharSound("S_SADNESS", CHAR_SOUND_S_SADNESS),
			new CharSound("S_SLAUGHTER", CHAR_SOUND_S_SLAUGHTER),
			new CharSound("S_SLAYON", CHAR_SOUND_S_SLAYON),
			new CharSound("S_SLIVER", CHAR_SOUND_S_SLIVER),
			new CharSound("S_TITAN", CHAR_SOUND_S_TITAN),
			new CharSound("S_TOWERGOLEM", CHAR_SOUND_S_TOWERGOLEM),
			new CharSound("S_TYPHOON", CHAR_SOUND_S_TYPHOON),
			new CharSound("S_VAMPIRICBAT", CHAR_SOUND_S_VAMPIRICBAT),
			new CharSound("S_WITCH", CHAR_SOUND_S_WITCH),
