...
public class Style {
	...
	public static void initStyle(Application app) {
		...
		{
			IconComponent on = new IconComponent( "/com/simsilica/lemur/icons/Glass-check-on.png",
					1f, 0, 0, 1f, false );
		    on.setColor(color(0.5, 0.9, 0.9, 0.9));
		    on.setMargin(5, 0);
		    IconComponent off = new IconComponent( "/com/simsilica/lemur/icons/Glass-check-off.png",
		    		1f, 0, 0, 1f, false );
